...
public class XYSeries implements Serializable {
  ...
  protected final IndexXYMap<Double, Double> mXY = new IndexXYMap<Double, Double>();
  /** The minimum value for the X axis. */
  protected double mMinX = MathHelper.NULL_VALUE;
  /** The maximum value for the X axis. */
  protected double mMaxX = -MathHelper.NULL_VALUE;
